...
$(document).mousemove(function(e){// to get the cursor point to drop an icon
    ...
    $("#jsPlumbContainer").droppable({
		...
		if(type== "SwitchMediator"){			
			$("#jsPlumbContainer").append('<div id='+"#"+objName+' style="height: 400px;width: 400px;background: #fffff0;"><div id="jsPlumbContainer1" style="position: relative;width: 100%;height: 100%;"><table width="100%" height="100%"><col width="30%"><col width="70%"><tr><td  style="height: 100%;width: 30%; border:1px solid #ccc; border-width:1px 1px 1px 1px;" id="draggedSwitchMediator2" rowspan="2" style="border:1px solid #ccc; border-width:1px 1px 1px 1px;">Switch Mediator</td><td style="border:1px solid #ccc; border-width:1px 1px 1px 1px;"><div id="jsPlumbContainerWrapper11" class="well-lg"  style="height:100%; width:100%; background: #ffffff;">Case</div></td></tr><tr><td style="border:1px solid #ccc; border-width:1px 1px 1px 1px;"><div id="jsPlumbContainerWrapper12" class="well-lg"  style="height:100%; width:100%; background: #ffffff;">Default</div></td></tr></table></div></div>');
		...
		connectDivs(lastItem,$("#"+objName));                   
                ...
                if(type!= "SwitchMediator"){lastItem = $("#"+objName);}
		}
...
$(document).on('drop','#jsPlumbContainerWrapper11',function (ev, ui)  {alert("IM HERE!!!");});
 $(currentId).droppable({
